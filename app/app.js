/* Design preview. All access rules below simulate UI states only.
...
function overview(){const identity=project.sections.identity;const er=output('Net emission reductions, per year');
 return `${window.CIPMap.markup(geoSVG())}<section class="project-hero"><div class="hero-copy"><div class="eyebrow">Kenya / Nature-based solutions</div><h2>A rangeland restoration project in the Maasai Mara.</h2><p>A grassland restoration and conservation project built around sustainable grazing management in the Maasai Mara landscape.</p><a class="button primary" href="#/project/${entooma}/documents">Explore project documents →</a><div class="hero-facts"><div><strong>${esc(identity.methodology.id)}</strong>Grassland methodology</div><div><strong>VCS / CCB</strong>Standards in project design</div></div></div></section>
...
function renderProject(id,tab){
 ...
 if(tab==='overview')window.CIPMap.mount(geo);
